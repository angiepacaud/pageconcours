	...
	<div class="container">
		...
		<div class="row contact-info"
			...
			<div class="col-md-6 col-sm-6 left-part">
				...
				<ul class="icon-list">
					<strong>Le Cercle de Lecture BBT</strong><br>
					    <img src="/img/logo_bbt.png" align="left" class="img-responsive" style="margin-left: auto; margin-right: 5%; display: block; width: 80px; height: 80px;" />
			...
			<div class="col-md-6 col-sm-6 right-part">
				...
				<div class="head">
					<h1 class="coordonnees">&Eacute;CHEANCIER DU CONCOURS : </h1>
		...
		<div class="col-md-6 col-sm-6">
		  <a id="error"></a>
				...
				<div class="form-group {!! $errors->has('manuscrits') ? 'has-error' : '' !!}">
					...
					<p class="for">{!! Form::label('firstname', 'Prénom') !!} {!! Form::text('firstname') !!} {!! $errors->first('firstname', '<small class="help-block">:message</small>') !!} </p>

					<p class="for">{!! Form::label('name', 'Nom') !!} {!! Form::text('name') !!} {!! $errors->first('name', '<small class="help-block">:message</small>') !!}</p>
		...
		{!! Form::submit('Envoyer', ['class' => 'btn btn-info center-block']) !!}
		</div>
		{!! Form::close() !!}
		<div id="success"></div>
	</div>
